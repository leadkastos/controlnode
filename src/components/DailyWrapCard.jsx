...
import { dailyWrapSnippet } from '../data/mockData'
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <div className="flex items-center gap-3 flex-wrap mt-auto">
          <button
            ...
            onClick={(e) => { e.stopPropagation(); nav('/daily-wrap') }}
          >
            View Full Wrap
            <ArrowRight size={14} />
          </button>
