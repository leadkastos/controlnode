          ...
          {[
            {
              ...
              duration: '~45 min',
              url: 'https://www.youtube.com/watch?v=OZsMd-5yDYY&t=6s',
              tag: 'Part 1',
              tagColor: '#10b981',
            },
            {
              ...
              duration: '~38 min',
              url: 'https://www.youtube.com/watch?v=CRHvvC4vqqs&t=12s',
              tag: 'Part 2',
              tagColor: '#f59e0b',
            },
            {
              ...
              duration: '~32 min',
              url: 'https://www.youtube.com/watch?v=UnE9Iz6iLUs&t=13s',
              tag: 'Part 3',
              tagColor: '#06b6d4',
            },
            {
              ...
              duration: '~41 min',
              url: 'https://www.youtube.com/watch?v=46TUpfxIfww&t=23s',
              tag: 'Part 4',
              tagColor: '#8b5cf6',
            },
          ].map((video, i) => (
